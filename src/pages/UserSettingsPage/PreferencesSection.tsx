...
export function PreferencesSection() {
  ...
  return (
    <section className="w-dvw p-20">
      <div>
        <h3 className="text-6xl font-bold font-(family-name:--profile-title-font) text-[var(--profile-title-color)] text-shadow-[var(--profile-title-shadow)]">
          Preferências da Aplicação
        </h3>
        <p className="text-4xl font-medium font-(family-name:--profile-subtitle-font) text-[var(--profile-subtitle-color)]">
      ...
      <div className="p-12">
        ...
        <div className="flex items-center justify-center gap-16">
          <div className="flex flex-col justify-center items-center gap-8">
            <h4 className="text-4xl font-medium font-(family-name:--preferences-theme-title-font) text-[var(--preferences-theme-title-color)] text-shadow-[var(--preferences-theme-title-shadow)] p-4  ">
              Selecione o idioma
            </h4>
          ...
          <div className="flex flex-col justify-center items-center gap-8">
            <h4 className="text-4xl font-medium font-(family-name:--preferences-theme-title-font) text-[var(--preferences-theme-title-color)] text-shadow-[var(--preferences-theme-title-shadow)] p-4  ">
              Receber notificações po E-mail
            </h4>
