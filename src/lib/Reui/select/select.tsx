...
const selectTriggerVariants = cva(
  `
    flex bg-background w-full items-center justify-between outline-none border border-[var(----greetings-color-1:#00ff00)] shadow-xs shadow-black/5 transition-shadow 
